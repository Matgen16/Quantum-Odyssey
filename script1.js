...
function confirmChanges() {
    if (darkMode == 1) {
        if (confirm("Are You Sure? This Will Reset The Level")) {
            window.location.assign("index1 dark.html")
        }
    }
}
function initiate() {
    ...
    drawText("This is a Quantum Wall ➡", 350, window.innerHeight/2,"#aa3388", "30px Arial")
    drawText("You Cant Move Through It In Your Quantum State", 25, window.innerHeight/2+40,"#aa3388", "30px Arial")
...
function drawCollisionsIn1() {
    if (quantumState == 1) {
        ...
        ctx.fillRect(window.innerWidth / 2-50, 0, 50, window.innerHeight - 100)
    } else {
